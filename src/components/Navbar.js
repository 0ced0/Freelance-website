...
export const Navbar = () => {
    ...
    return (
        <div className="w-full pt-3 flex justify-between">
            ...
            {/* Supposed Logo */}
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className=" w-10 h-10 text-[#b5cb00] ml-2">
            ...
            {/* Menu Field */}
            <div className=" w-[25%] flex justify-around ml-[25%]">
                ...
                <button
                    type="button"
                    onClick={openMenu} >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="relative w-7 h-7 ">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                    </svg>
                </button>
                {isMenuOpen && (
                    <div className="bg-red-100 absolute mt-16 ml-10 p-4 rounded-[15px] space-y-5">
                ...
                {isMenuOpen && (
                    <div>
                        <button
                        onClick={menuClickHandler}></button>
                    <div/>
                ) } */}
