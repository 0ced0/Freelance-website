...
export const Navbar = ({ isProfileOpen, toggleMenu }) => {
    ...
    return (
        <div className="w-full pt-3 flex justify-between bg-white pb-2 shadow-lg">
            ...
            {/* Menu Field */}
            <div className=" w-[25%] flex ml-[25%] justify-end mr-5">
                ...
                {/* Menu Option */}
                {
                    isProfileOpen && (
                        <div className="flex flex-col space-y-4 bg-white rounded-lg shadow-[0px_5px_35px_0px_rgba(0,0,0,0.2)] p-3 absolute right-10 top-16">
                            <button onClick={menuPages.goToProfile} className="hover:text-[#57ba4c] text-left">My Job Postings</button>
                        </div>
                    )
                }
            </div>
